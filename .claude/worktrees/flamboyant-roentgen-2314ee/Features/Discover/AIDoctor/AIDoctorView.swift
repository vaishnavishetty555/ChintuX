...
struct AIDoctorView: View {
    ...
    private func showGreeting() {
        ...
        if activePets.isEmpty {
            opening = "Hey! I'm Dr. Ruff — add a pet profile first and I'll be able to give you personalised advice."
        } else {
            opening = "Hey! Good to have you here. I'm Dr. Ruff — I've got profiles for \(petNamesDisplay). Ask me anything about any of them, or just describe what you're seeing."
        }
                ...
                if sessionStore.sessions.isEmpty {
                    VStack(spacing: 16) {
                        ...
                        Text("No saved chats yet")
                            ...
                            .foregroundStyle(PawlyColors.ink)
                        Text("Your conversations with Dr. Ruff will appear here.")
                            .font(PawlyFont.bodyMedium)
                            .foregroundStyle(PawlyColors.slate)
